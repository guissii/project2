            ...
            <aside className="w-[320px] bg-slate-900/50 backdrop-blur-3xl flex flex-col border-r border-slate-800/60 z-20 relative">
                ...
                <div className="px-6 mb-8 mt-2 relative z-10">
                    <div className="bg-slate-800/50 rounded-[2rem] p-5 border border-slate-700/50 flex items-center gap-4 hover:bg-slate-800 transition-colors cursor-pointer group shadow-inner">
                        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center text-white font-black text-lg border-2 border-slate-700 shadow-sm group-hover:scale-105 transition-transform">
                            AD
                        </div>
                        <div className="flex-1">
                            <p className="text-[15px] font-black text-slate-100 leading-tight group-hover:text-emerald-400 transition-colors">Directeur MEN</p>
                ...
                <div className="p-6 relative z-10">
                    ...
                    <button className="flex items-center justify-center gap-3 w-full py-4 rounded-2xl text-slate-500 hover:text-rose-400 hover:bg-rose-950/30 border border-transparent hover:border-rose-900/50 font-bold transition-all group">
